...
function UpdateBackground() {
    ...
    if ("home" !== a || "home" !== b) {
        var c = GetRandomInt(1, $backgroundImages.length), d = $backgroundImages[c].src;
        $body.css("background-image", "url('" + d + "')");
    }
}

function LoadBackgroundImages() {
    for (var a = new Array(), b = 0; 8 > b; b++) {
        var c = new Image();
        c.src = "/wp-content/themes/astral-wp/library/images/background/" + (b + 1) + ".jpg", 
        a.push(c);
    }
    fool = a;
}
...
function Project(a, b, c, d, e, f, g) {
    ...
    h.media = g, h.featureImageIsVisible = ko.observable(!1), h.showFeatureImage = function() {
        console.log(h.featureImage), void 0 !== h.featureImage && null !== h.featureImage && "" !== h.featureImage && h.featureImageIsVisible(!0);
...
function ProjectListViewModel(a) {
    ...
    c.selectedTagsSummary = ko.observable(), jQuery.getJSON(serviceRoot + "/astral/v1/project", null, function(b) {
        ...
        a.tagListVM.selectedTags([]), c.updateSelectedProjectList();
    };
}
...
var $projectNode, $homeNode, $menu, $project, $topAnchor, $projectImage, $astralBanner, $wpAdminBar, $body, $backgroundImages, serviceRoot = "http://astr.nsur.org/wp-json", previousRoute = "", appVM = new AppViewModel(), backgroundImages = new Array();

$(function() {
    LoadBackgroundImages(), $projectNode = document.getElementById("project"), $homeNode = document.getElementById("home"), 
    ...
    $wpAdminBar = jQuery("#wpadminbar"), $body = jQuery("body"), $backgroundImages = jQuery("#backgroundImages img"), 
