...
function ScrollToAnchor(a) {
    ...
    $wpAdminBar.length > 0 && (c += $wpAdminBar.height()), $("html, body").animate({
...
function UpdateBackground() {
    ...
    if ("home" !== a || "home" !== b) {
        var c = GetRandomInt(1, 8);
        $("body").css("background-image", "url('/wp-content/themes/astral-wp/library/images/background/" + c + ".jpg')");
    }
}
...
function RouteHome(a) {
    ...
    console.log(a), console.log("home-anchor"), a.length > 0 && ScrollToAnchor(a);
}
...
var $projectNode, $homeNode, $menu, $project, $topAnchor, $projectImage, $astralBanner, $wpAdminBar, serviceRoot = "http://192.168.99.100:8081/wp-json", previousRoute = "", appVM = new AppViewModel();
...
$(function() {
    ...
    $wpAdminBar = jQuery("#wpadminbar"), ko.applyBindings(appVM, document.getElementById("content")), 
