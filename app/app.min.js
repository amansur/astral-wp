    ...
    c.selectedTagsSummary = ko.observable(), jQuery.getJSON(serviceRoot + "/astral/v1/project", null, function(b) {
        ...
        if (a.tagListVM.selectedTags() && 0 !== a.tagListVM.selectedTags().length) {
            ...
            var d = ko.utils.arrayFilter(c.projects(), function(b) {
                var d = !1, e = [];
                return b.tags.forEach(function(c) {
                    -1 !== a.tagListVM.selectedTags().indexOf(c) && (e.push(b.slug), d = !0);
                }), c.projectLookup(e), d;
            });
            ...
            c.projects().forEach(function(a, b) {
                e.push(a.slug);
            }), c.projectLookup(e), c.selectedProjects(SplitArrayIntoN(c.projects(), b)), c.selectedTagsSummary("");
        }
