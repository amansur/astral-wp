...
function LoadBackgroundImages() {
    for (var a = 0; 8 > a; a++) {
        var b = new Image();
        b.src = "/wp-content/themes/astral-wp/library/images/background/" + (a + 1) + ".jpg";
    }
}
...
var $projectNode, $homeNode, $menu, $project, $topAnchor, $projectImage, $astralBanner, $wpAdminBar, serviceRoot = "http://192.168.99.100:8081/wp-json", previousRoute = "", appVM = new AppViewModel(), backgroundImages = new Array();
...
$(function() {
    ...
    UpdateBackground(), DisplayScrollToTop(), $(window).on("scroll", function() {
        ...
        appVM.projectListVM.updateSelectedProjectList(), $("#filterList").slideToggle();
